    ...
    return (
        <div>
            <div className={"text-center mt-32 mx-auto px-2 mb-32 max-w-[800px]"}>
                <h1 className="text-4xl sm:text-6xl md:text-7xl title-font">Vytvářejte prezentace s pomocí <span className={"title-highlighted"}>A.I.</span></h1>
                <p className="text-gray-400 text-xl mt-6 md:mx-32">Profesionální a přizpůsobitelná prezentace do práce, do školy i pro osobní projekty v řádu vteřin.</p>
            </div>
            ...
            <div className="flex flex-wrap items-stretch text-justify justify-center items-center">
                {
                    [props.props.card1, props.props.card2, props.props.card3].map((card, index) => {
                        return (
                            <div className="w-1/3 md:p-5 border-red-500 min-w-[380px] max-w-[440px]" key={index}>
                                {/*border border-gray-700 bg-t-blue-700 shadow-lg*/}
                                <div className=" rounded-lg h-full border-purple-500 pb-8 md:p-4 min-w-[350px]">
