...
export default function Popup(props: React.PropsWithChildren<{className?: string, trigger: React.ReactElement, title: string}>) {
            ...
            <AnimatePresence>
                {
                    ...
                    >
                        <div onClick={() => setIsOpen(false)}
                             className={twMerge("fixed top-0 left-0 w-full h-full bg-black bg-opacity-40 flex justify-center items-center " + (props.className ?? ""))}>
